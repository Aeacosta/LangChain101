...
def read_local_file(file_path: str) -> str:
    ...
    """
    # Defensive programming: prevent the agent from escaping the workspace directory
...
The name of the C# file being analyzed.
...
An array of detected code smells.
...
The `diff` must contain only the relevant code changes.

If no safe refactoring can be proposed, use:
...
""", [find_documents, read_local_file], logger=log)

user_prompt = "Que Code Smells detectas en este archivo? Ejemplos/CodeSmell2.cs"
